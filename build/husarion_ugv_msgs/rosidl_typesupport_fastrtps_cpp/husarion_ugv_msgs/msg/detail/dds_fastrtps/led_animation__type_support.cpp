...
#include "husarion_ugv_msgs/msg/detail/led_animation__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const husarion_ugv_msgs::msg::LEDAnimation & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  husarion_ugv_msgs::msg::LEDAnimation & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = husarion_ugv_msgs::msg::LEDAnimation;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const husarion_ugv_msgs::msg::LEDAnimation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<husarion_ugv_msgs::msg::LEDAnimation *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LEDAnimation__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const husarion_ugv_msgs::msg::LEDAnimation *>(
...
static size_t _LEDAnimation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LEDAnimation(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LEDAnimation__callbacks = {
...
static rosidl_message_type_support_t _LEDAnimation__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LEDAnimation__callbacks,
...
{
  return &husarion_ugv_msgs::msg::typesupport_fastrtps_cpp::_LEDAnimation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, husarion_ugv_msgs, msg, LEDAnimation)() {
  return &husarion_ugv_msgs::msg::typesupport_fastrtps_cpp::_LEDAnimation__handle;
}
