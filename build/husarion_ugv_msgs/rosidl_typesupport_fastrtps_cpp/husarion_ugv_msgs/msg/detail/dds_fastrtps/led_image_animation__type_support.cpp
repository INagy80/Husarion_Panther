...
#include "husarion_ugv_msgs/msg/detail/led_image_animation__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const husarion_ugv_msgs::msg::LEDImageAnimation & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  husarion_ugv_msgs::msg::LEDImageAnimation & ros_message)
{
  // Member: image
  cdr >> ros_message.image;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = husarion_ugv_msgs::msg::LEDImageAnimation;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const husarion_ugv_msgs::msg::LEDImageAnimation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<husarion_ugv_msgs::msg::LEDImageAnimation *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LEDImageAnimation__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const husarion_ugv_msgs::msg::LEDImageAnimation *>(
...
static size_t _LEDImageAnimation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LEDImageAnimation(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LEDImageAnimation__callbacks = {
...
static rosidl_message_type_support_t _LEDImageAnimation__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LEDImageAnimation__callbacks,
...
{
  return &husarion_ugv_msgs::msg::typesupport_fastrtps_cpp::_LEDImageAnimation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, husarion_ugv_msgs, msg, LEDImageAnimation)() {
  return &husarion_ugv_msgs::msg::typesupport_fastrtps_cpp::_LEDImageAnimation__handle;
}
