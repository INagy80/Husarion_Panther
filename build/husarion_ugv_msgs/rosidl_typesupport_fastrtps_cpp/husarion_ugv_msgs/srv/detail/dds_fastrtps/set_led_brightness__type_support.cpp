...
#include "husarion_ugv_msgs/srv/detail/set_led_brightness__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = husarion_ugv_msgs::srv::SetLEDBrightness_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const husarion_ugv_msgs::srv::SetLEDBrightness_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<husarion_ugv_msgs::srv::SetLEDBrightness_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetLEDBrightness_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const husarion_ugv_msgs::srv::SetLEDBrightness_Request *>(
...
static size_t _SetLEDBrightness_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetLEDBrightness_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetLEDBrightness_Request__callbacks = {
...
static rosidl_message_type_support_t _SetLEDBrightness_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetLEDBrightness_Request__callbacks,
...
get_message_type_support_handle<husarion_ugv_msgs::srv::SetLEDBrightness_Request>()
{
  return &husarion_ugv_msgs::srv::typesupport_fastrtps_cpp::_SetLEDBrightness_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = husarion_ugv_msgs::srv::SetLEDBrightness_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const husarion_ugv_msgs::srv::SetLEDBrightness_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<husarion_ugv_msgs::srv::SetLEDBrightness_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetLEDBrightness_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const husarion_ugv_msgs::srv::SetLEDBrightness_Response *>(
...
static size_t _SetLEDBrightness_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetLEDBrightness_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetLEDBrightness_Response__callbacks = {
  "husarion_ugv_msgs::srv",
...
static rosidl_message_type_support_t _SetLEDBrightness_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetLEDBrightness_Response__callbacks,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_husarion_ugv_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<husarion_ugv_msgs::srv::SetLEDBrightness_Response>()
{
  return &husarion_ugv_msgs::srv::typesupport_fastrtps_cpp::_SetLEDBrightness_Response__handle;
}
...
// functions for husarion_ugv_msgs::srv::SetLEDBrightness_Request already declared above

// functions for husarion_ugv_msgs::srv::SetLEDBrightness_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        husarion_ugv_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetLEDBrightness_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        husarion_ugv_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetLEDBrightness_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = husarion_ugv_msgs::srv::SetLEDBrightness_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        husarion_ugv_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetLEDBrightness_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        husarion_ugv_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetLEDBrightness_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const husarion_ugv_msgs::srv::SetLEDBrightness_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<husarion_ugv_msgs::srv::SetLEDBrightness_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetLEDBrightness_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const husarion_ugv_msgs::srv::SetLEDBrightness_Event *>(
...
static size_t _SetLEDBrightness_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetLEDBrightness_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetLEDBrightness_Event__callbacks = {
  "husarion_ugv_msgs::srv",
...
static rosidl_message_type_support_t _SetLEDBrightness_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetLEDBrightness_Event__callbacks,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_husarion_ugv_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<husarion_ugv_msgs::srv::SetLEDBrightness_Event>()
{
  return &husarion_ugv_msgs::srv::typesupport_fastrtps_cpp::_SetLEDBrightness_Event__handle;
}
...
static service_type_support_callbacks_t _SetLEDBrightness__callbacks = {
  "husarion_ugv_msgs::srv",
  "SetLEDBrightness",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, husarion_ugv_msgs, srv, SetLEDBrightness_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, husarion_ugv_msgs, srv, SetLEDBrightness_Response)(),
...
static const rosidl_service_type_support_t _SetLEDBrightness__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetLEDBrightness__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<husarion_ugv_msgs::srv::SetLEDBrightness_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<husarion_ugv_msgs::srv::SetLEDBrightness_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<husarion_ugv_msgs::srv::SetLEDBrightness_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<husarion_ugv_msgs::srv::SetLEDBrightness>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<husarion_ugv_msgs::srv::SetLEDBrightness>,
...
get_service_type_support_handle<husarion_ugv_msgs::srv::SetLEDBrightness>()
{
  return &husarion_ugv_msgs::srv::typesupport_fastrtps_cpp::_SetLEDBrightness__handle;
}
